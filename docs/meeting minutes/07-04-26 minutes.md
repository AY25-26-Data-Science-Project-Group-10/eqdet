...
2. Tom's progress
    - Generated metrics for earthquakes and explosions for both EQTransformer and EQCCTPro
...
5. TODO:
    - Use BlocklyEQTransfomer to fine-tune the pre-trained EQTransformer model
